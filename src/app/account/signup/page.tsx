...
import { TextInput, PasswordInput, Button, Paper, Divider, Stack, Checkbox } from '@mantine/core'
    ...
    <>
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          ...
          <Link href="/account" className="font-medium text-blue-600 hover:underline dark:text-blue-400">
            Sign in
          </Link>
        </p>
      </div>
